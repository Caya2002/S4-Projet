...
void __ISR(_TIMER_2_VECTOR, ipl1AUTO) _IntHandlerTmr2(void){//exécute à 10Hz
//      switch (main.state) {
//        case INITIALISATION:
...
//    }
//
//    switch (calibration_etat) {
//        case HORS_CALIBRATION:
//            LCD_WriteStringAtPos("HORS-CALIBRATION", 1, 0);
//            break;
//
//        case ATTENTE_YEUX_OUVERTS:
//            LCD_WriteStringAtPos("ATTENTE YEUX-O  ", 1, 0);
//            break;
//
//        case CALIBRATION_YEUX_OUVERTS:
//            LCD_WriteStringAtPos("CALIB YEUX-O    ", 1, 0);
//            break;
//
//        case ATTENTE_YEUX_FERMES:
//            LCD_WriteStringAtPos("ATTENTE YEUX-F  ", 1, 0);
//            break;
//
//        case CALIBRATION_YEUX_FERMES:
//            LCD_WriteStringAtPos("CALIB YEUX-F    ", 1, 0);
//            break;
//
//        case CALCUL_NORMALISATION:
//            LCD_WriteStringAtPos("CALCUL          ", 1, 0);
//            break;
//        default:
//            break;
//    }
